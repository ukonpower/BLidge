...
from .managers.fcurve import BLidgeFCurveProperty
...
class BLidgeProperties(bpy.types.PropertyGroup):
    ...
    def register():
        bpy.types.Scene.blidge = bpy.props.PointerProperty(type=BLidgeProperties)
